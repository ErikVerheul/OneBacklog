...
TARGET_DIR=erik@onebacklog.net:~
echo "The source directory is set to: $SOURCE_PATH"
echo "The files index.html, favicon.ico, maintenance.tml and localhost-https.html will be copied from $SOURCE_PATH to your target directory:"
