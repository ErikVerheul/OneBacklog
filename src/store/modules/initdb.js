					...
					details: {
						map: `function(doc) {
							...
							if (doc.type == "backlogItem" && !doc.delmark && doc.level) emit([doc.level, seq, -doc.priority],
								...
								doc.lastAttachmentAddition, doc.lastAttachmentRemoval, doc.lastOtherChange, doc.lastCommentAddition, doc.lastContentChange, doc.lastPositionChange, doc.lastStateChange])
						}`,
					},
