				...
				<BRow class="my-1">
					...
					<BCol sm="12">
						...
						<div v-if="filterOnTeams" class="indent20">
							<BFormGroup>
								<BFormCheckboxGroup v-model="selectedTeams" :options="teamOptions" />
							</BFormGroup>
						</div>
						<hr />
					</BCol>
					...
					<BCol sm="12">
						...
						<div v-if="filterOnState" class="indent20">
							<BFormGroup>
								<BFormCheckboxGroup v-model="selectedStates" :options="stateOptions" />
							</BFormGroup>
						</div>
						<hr />
					</BCol>
					...
					<BCol sm="12">
						...
						<div v-if="filterOnTime" class="indent20">
							...
							<div v-if="selectedTime === '0'">
								...
								<BCol sm="9">
									<BFormInput v-model="fromDate" type="date" />
								</BCol>
								<BCol sm="3">
									<label>To:</label>
								</BCol>
								<BCol sm="9">
									<BFormInput v-model="toDate" type="date" />
								</BCol>
							</div>
						</div>
						<hr />
...
const methods = {
	...
	onApplyMyFilters() {
		...
		if (
			store.getters.isResetFilterSet ||
			(!this.filterOnDependencies && !this.filterOnReqAreas && !this.filterOnTeams && !this.filterTreeDepth && !this.filterOnState && !this.filterOnTime)
		)
			return
