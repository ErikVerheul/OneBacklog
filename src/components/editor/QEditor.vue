/* * This component is based on the adapted QuillyEditor component with a set theme and toolbar. * It emits a blur when leaving the editor area to the toolbar or anywhere else. */
