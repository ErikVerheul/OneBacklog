	...
	<div>
		...
		<BContainer fluid>
			...
			<div v-else>
				...
				<h5>
					Exit and sign-in again. Open the drop down menu under 'Select your view' in the header. Select the 'Admin' view to create the first users and set their roles. Assign one
					or more admins to take over your admin task. You may also create a custom sprint calendar.
				</h5>
