		...
		<div class="row">
			...
			<div class="col-lg-12 col-sm-12" id="signin">
				...
				<div v-if=this.$store.state.demo class="text-center">
					...
					<p>Note that demoUser has the overall permission of Area PO and the permissions of "PO", "developer" and "guest" for the 'Register your feature proposals and bug findings here' and 'Feel free to play with this product'.<br>
