  ...
  <div>
    ...
    <multipane class="custom-resizer" layout="vertical">
      <div class="pane" :style="{ minWidth: '30%', width: '50%', minHeight: '100%' }">
        ...
        >Welcome {{ $store.state.load.user }}. Your current database is set to {{ $store.state.currentDb }}. You have {{ $store.state.load.userAssignedProductIds.length }} product</h6>
        <h6
          v-if="$store.state.load.userAssignedProductIds.length >1"
        >Welcome {{ $store.state.load.user }}. Your current database is set to {{ $store.state.currentDb }}. You have {{ $store.state.load.userAssignedProductIds.length }} products</h6>
        <span
          class="square"
