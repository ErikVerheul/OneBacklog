    ...
    <CContainer>
      ...
      <template v-if="optionSelected === 'Select a task'">
        ...
        <CButtonGroup vertical role="group" aria-label="Vertical button group">
          <CButton block @click="createUser">Create a user and assign product(s)</CButton>
          <CButton block @click="maintainUsers">Maintain user permissions to products </CButton>
          <CButton block @click="removeUser" variant="warning">Remove a user</CButton>
          <br />
          <CButton block @click="createProduct">Create a product</CButton>
          <CButton block @click="removeProduct" variant="warning">Remove a product with all descendant items from a
            database</CButton>
          <br />
          <CButton block @click="createTeam">Create a team</CButton>
          <CButton block @click="removeTeams">Remove teams without members</CButton>
          <CButton block @click="listTeams">List teams</CButton>
          <br />
          <CButton block @click="maintainDefaultSprintCalendar">Maintain the default sprint calendar</CButton>
          <CButton block @click="createOrUpdateTeamCalendar">Create / Maintain a team sprint calendar</CButton>
        </CButtonGroup>
      </template>
      <template v-else>
        <div v-if="optionSelected === 'Remove a product'">
          ...
          <CButton class="m-1" @click="showProductView()" variant="primary">Switch to product view</CButton>
          <CButton class="m-1" @click="cancel()">Cancel</CButton>
        </div>
        <template v-else-if="getUserFirst">
          ...
          <template v-if="!$store.state.isUserFound">
            <hr>
            <CButton v-if="selectedUser && !$store.state.isUserFound" class="m-1"
              @click="doFetchUser(selectedUser, false)" variant="primary">Continue</CButton>
            <CButton v-if="!$store.state.isUserFound" class="m-1" @click="cancel">Cancel</CButton>
          </template>
          <div v-if="optionSelected === 'Remove a user'">
            <div v-if="$store.state.isUserFound && !$store.state.isUserDeleted">
              <hr>
              <CButton class="m-1 btn btn-danger" @click="doRemoveUser" variant="primary">Remove user '{{ selectedUser }}'
              </CButton>
              <CButton class="m-1" @click="cancel">Cancel</CButton>
            </div>
            <template v-if="$store.state.isUserFound && $store.state.isUserDeleted">
              <hr>
              <CButton class="m-1" @click="cancel">Return</CButton>
            </template>
          </div>
                ...
                <div v-if="!isUserDbSelected">
                  <b-col sm="12">
                    <b-form-group>
                      ...
                      <b-form-radio-group v-model="$store.state.selectedDatabaseName"
                        :options="$store.state.databaseOptions" stacked></b-form-radio-group>
                    </b-form-group>
                    <CButton class="m-1" @click="isUserDbSelected = true" variant="primary">Continue</CButton>
                    <CButton class="m-1" @click="cancel()">Cancel</CButton>
                  </b-col>
                </div>
                <div v-else>
                  <b-col sm="12">
                    ...
                    <b-form-group>
                      <b-form-checkbox v-model="$store.state.useracc.userIsAdmin">Add or remove the 'admin'
                        role</b-form-checkbox>
                      <b-form-checkbox v-model="$store.state.useracc.userIsAPO">Add or remove the 'APO'
                        role</b-form-checkbox>
                    </b-form-group>
                    ...
                    <b-form-checkbox v-model="$store.state.useracc.userIsAssistAdmin">Add or remove the 'assistAdmin'
                      role</b-form-checkbox>
                  </b-col>

                  <b-col v-if="!$store.state.areProductsFound" sm="12">
                    <hr>
                    <CButton class="m-3" @click="callGetDbProducts(false)" variant="primary">Continue detail role
                      assignment</CButton>
                    <CButton class="m-1" @click="cancel()">Cancel</CButton>
                  </b-col>
                  <b-col sm="12">
                    <div v-if="$store.state.areProductsFound">
                      ...
                      <CButton
                        ...
                        Update this user</CButton>
                      <CButton v-if="!$store.state.isUserUpdated" class="m-1" @click="cancel()">Cancel</CButton>
                      <CButton v-else class="m-1" @click="cancel()">Return</CButton>
                    </div>
                  </b-col>
                </div>
              </b-row>
        ...
        <template v-else>
          <div v-if="!dbIsSelected">
            ...
            <hr>
            <CButton class="m-1" @click="doAfterDbIsSelected()" variant="primary">Continue</CButton>
            <CButton class="m-1" @click="cancel()">Cancel</CButton>
          </div>
          <div v-else>
                ...
                <b-row>
                  ...
                  <b-col sm="10">
                    <b-form-input v-model="password" type="password"
                      placeholder="Enter the initial password. The user must change it."></b-form-input>
                  </b-col>
                  <b-col sm="2">
                    Users e-mail:
                  </b-col>
                  ...
                  <hr>
                  <b-col sm="12">
                    <CButton v-if="!credentialsReady" class="m-1" @click="checkCredentials" variant="primary">Continue
                    </CButton>
                    <CButton class="m-1" @click="cancel">Cancel</CButton>
                  </b-col>
                </b-row>
              ...
              <div v-if="credentialsReady">
                <div v-if="$store.state.areProductsFound">
                  ...
                  <template v-if="!$store.state.isUserCreated">
                    ...
                    <CButton class="m-1" @click="doCreateUser" variant="primary">Create this user</CButton>
                    <CButton class="m-1" @click="cancel">Cancel</CButton>
                  </template>
                </div>
                <div v-else>
            ...
            <template v-else-if="optionSelected === 'Create a product'">
              <template>
                ...
                <template v-if="!$store.state.isProductCreated">
                  <CButton v-if="productTitle !== ''" class="m-3" @click="doCreateProduct" variant="primary">Create
                    product</CButton>
                  <CButton class="m-3" @click="cancel()">Cancel</CButton>
                </template>
              </template>
              <template v-if="$store.state.isProductCreated">
                ...
                <hr>
                <CButton class="m-3" @click="cancel()">Return</CButton>
              </template>
            </template>
            ...
            <template v-else-if="optionSelected === 'Create a team'">
              ...
              <template v-if="!$store.state.isTeamCreated">
                <CButton v-if="teamName !== ''" class="m-3" @click="doCreateTeam" variant="primary">Create this team
                </CButton>
                <CButton class="m-1" @click="cancel">Cancel</CButton>
              </template>
              <CButton v-else class="m-3" @click="cancel">Return</CButton>
            </template>
            ...
            <template v-else-if="optionSelected === 'Remove teams without members'">
              ...
              <b-form-group label="Select one or more teams to remove">
                <b-form-checkbox-group v-model="teamNamesToRemove"
                  :options="teamsToRemoveOptions"></b-form-checkbox-group>
              </b-form-group>

              <template v-if="!$store.state.areTeamsRemoved">
                <CButton class="m-1" @click="doRemoveTeams(teamNamesToRemove)" variant="primary">Remove teams</CButton>
                <CButton class="m-1" @click="cancel">Cancel</CButton>
              </template>
              <CButton v-else class="m-1" @click="cancel">Return</CButton>
            </template>
            ...
            <template
              ...
              <template v-if="optionSelected === 'Maintain the default sprint calendar'">
                ...
                <div v-if="checkForExistingCalendar">
                  <CButton @click="doLoadDefaultCalendar" variant="primary">Load the default sprint calendar</CButton>
                </div>
              </template>
              ...
              <template v-else-if="optionSelected === 'Create / Maintain a team sprint calendar'">
                ...
                <template v-if="!$store.state.isTeamCalendarLoaded">
                  ...
                  <template v-if="selectedTeamName">
                    <div v-if="checkForExistingCalendar">
                      <CButton @click="doLoadTeamCalendar" variant="primary">Load the team sprint calendar</CButton>
                    </div>
                    <div v-else>
                      ...
                      <p class="colorRed">This is a one way change. When the team calendar is created the team has to
                        maintain it.</p>
                      <CButton v-if="!$store.state.isCalendarSaved" class="m-1" @click="doCreateTeamCalendar"
                        variant="primary">Create team sprint calendar</CButton>
                      <CButton v-if="!$store.state.isCalendarSaved" class="m-1" @click="cancel">Cancel</CButton>
                      <CButton v-if="$store.state.isCalendarSaved" class="m-1" @click="cancel">Return</CButton>
                    </div>
                  </template>
                </template>
              </template>
              ...
              <template v-if="$store.state.isDefaultCalendarLoaded || $store.state.isTeamCalendarLoaded">
                ...
                <b-list-group>
                  <b-list-group-item button variant="secondary" v-CModal.modal-extend>Extend this calendar with new
                    sprints</b-list-group-item>
                  <b-list-group-item button variant="secondary" v-CModal.modal-change>Change a sprint length and shift
                    all its successors in time</b-list-group-item>
                </b-list-group>
                <CButton class="m-3" @click="cancel()">Return</CButton>
                <CModal @ok="extendCalendar" id="modal-extend" :ok-disabled="extendDisableOkButton"
                  title="Extend the number of sprints">
                  <b-form-input v-model="extendNumberStr" type="number"
                    placeholder="Enter the number of extensions"></b-form-input>
                </CModal>
                <CModal @ok="changeSprintInCalendar" id="modal-change" :ok-disabled="changeDisableOkButton"
                  ...
                  <CContainer>
                    <b-row class="mb-1">
                      ...
                      <b-col cols="9">
                        <b-form-input v-model="changedNumberStr" type="number"
                          placeholder="Enter the sprint number"></b-form-input>
                      </b-col>
                    </b-row>
                    {{ acceptSprintNrMsg }}
                    <div v-if="acceptSprintnr">
                      <b-row class="mb-1">
                        ...
                        <b-col cols="9">
                          <b-form-input v-model="changedDurationStr" type="number"
                            placeholder="Enter a new duration in days (1-28)"></b-form-input>
                        </b-col>
                        <b-col cols="3">
                          Hours shift
                        </b-col>
                        <b-col cols="9">
                          <b-form-input v-model="changedHourStr" type="number"
                            placeholder="Shift the sprint ending time (-12,+12) hours"></b-form-input>
                        </b-col>
                      </b-row>
                    </div>
