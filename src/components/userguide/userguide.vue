	...
	<b-container>
		<b-row>
			<b-col cols="12" class="left-column">
				...
				<p class="indent10">Click the <b>need assistance?</b> button for some valuable tips. Click on cancel or the small X when uncertain. After removal a <b>Undo remove</b> button appears in the title bar. Click on this button te reverse your removals (last removel will be restored first).</p>
