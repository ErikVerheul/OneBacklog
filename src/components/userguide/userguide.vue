	...
	<b-container>
		<b-row>
			<b-col cols="12" class="left-column">
				...
				<b-img class="indent10" :src="require('./remove.png')" alt="Example context remove" />
				<p class="indent10">Click the <b>need assistance?</b> button for some valuable tips. Click on cancel or the small X when uncertain. After removal a <b>Undo remove</b> button appears in the title bar. Click on this button te reverse your removals (last removel first). Note the warning: WARNING: do not change the tree if you want to undo the removal! When the location of the removed item has changed the undo will work on the database only. You will have to sing out and -in to see the effect.</p>
